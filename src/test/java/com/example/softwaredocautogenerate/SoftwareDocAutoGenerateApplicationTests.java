package com.example.softwaredocautogenerate;
...
@SpringBootTest
class SoftwareDocAutoGenerateApplicationTests {
...
//                .apiKey("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")
                .apiKey("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")
                .timeout(900)
                .proxy(proxy)
        ...
        String code = """
                ...
                """;
        String answer = chatGPT.chat("我给你一份样例代码，是用vue3以及element实现的，请根据样例代码生成一份关于角色管理的代码:\n"+code);
